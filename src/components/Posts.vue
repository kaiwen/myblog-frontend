<template>
    <v-container>
        ...
        <v-row class="justify-center">
            <v-col cols="10" xl="7">
                <p style="font-size:1.3em; line-height:1.6em; color: #3c4146">{{ articl.text }}</p>
            </v-col>
        </v-row>
    </v-container>
</template>
